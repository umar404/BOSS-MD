 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
   ...
   const sections = [
   {
	...
	rows: [
	    {title: `⚡ ${pmenus} 𝚂𝙿𝙴𝙴𝙳 𝙱𝙾𝚃`, rowId: ".ping", description: "𝙳𝚒𝚜𝚙𝚕𝚊𝚢𝚜 𝙱𝚘𝚝 𝚁𝚎𝚜𝚙𝚘𝚗𝚜𝚎 𝚜𝚙𝚎𝚎𝚍"},
	    {title: `⏰ ${pmenus} 𝚁𝚄𝙽𝚃𝙸𝙼𝙴 𝙱𝙾𝚃`, rowId: ".runtime", description: "𝙰𝚙𝚙𝚕𝚢 𝙱𝚘𝚝 𝚁𝚞𝚗𝚗𝚒𝚗𝚐 𝚃𝚒𝚖𝚎"}, 
	    {title: `💌 ${pmenus} 𝙾𝚆𝙽𝙴𝚁 𝙱𝙾𝚃`, rowId: ".creator", description: "𝚂𝚑𝚘𝚠𝚒𝚗𝚐 𝙸𝚗𝚏𝚘𝚛𝚖𝚊𝚝𝚒𝚘𝚗 𝙰𝚋𝚘𝚞𝚝 𝚄𝚖𝚊𝚛 𝙾𝚆𝙽𝙴𝚁"},
	    {title: `📔 ${pmenus} 𝚂𝙲𝚁𝙸𝙿𝚃 𝙱𝙾𝚃`, rowId: ".sc", description: `𝚂𝚘𝚞𝚛𝚌𝚎 𝙲𝚘𝚍𝚎 ${namebot}`},
	]
    },{
	title: `${htki} sᴜᴘᴘᴏʀᴛ ${htka}`,
	rows: [
	    {title: `💹 ${pmenus} 𝙳𝙾𝙽𝙰𝚃𝙴`, rowId: ".donasi", description: '𝚂𝚞𝚙𝚙𝚘𝚛𝚝 𝙾𝚗𝚠𝚎𝚛 𝚝𝚘 𝚋𝚎 𝚖𝚘𝚛𝚎 𝚎𝚗𝚝𝚑𝚞𝚜𝚒𝚊𝚜𝚝𝚒𝚌'},
	]
	},{
	title: `${htki} ᴍᴇɴᴜ ${htka}`,
	rows: [
	    {title: `💬 ${pmenus} All`, rowId: ".? all", description: "Show all BOSS MD BOT commands "},
	...
	{title: `🐚 ${pmenus} Kerang`, rowId: ".? kerangajaib", description: "Ask the club president"},
	{title: `📑 ${pmenus} Quotes`, rowId: ".? quotes", description: "Random Inspiration"},
	{title: `⛩️ ${pmenus} Anime`, rowId: ".? anime", description: "Wibu wibu🐦"},
	{title: `🔞 ${pmenus} Nsfw`, rowId: ".? nsfw", description: "Tch, basic sagnean"},
	...
	{title: `🌎 ${pmenus} Internet`, rowId: ".? internet", description: "Search something on BOSS MD BOT "},
	{title: `📩 ${pmenus} Downloaders`, rowId: ".? downloader", description: "Download Something On BOSS MD BOT"},
	...
	{title: `🗂️ ${pmenus} Database`, rowId: ".? database", description: "Save Something On BOSS MD BOT "},
            ...
            templateButtons: [
                {
                    urlButton: {
                        displayText: `${namebot}`,
                        url: 'https://github.com/umar404/BOSS-MD'
                    }
                },
                {
                    urlButton: {
