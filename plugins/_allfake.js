...
handler.all = async function (m) {
	...
	try {
		...
		// This is for the crator/owner command
		global.kontak2 = [
         [owner[0], await conn.getName(owner[0] + '@s.whatsapp.net'), ' ', 'yanxiao021@gmail.com', true],
         [owner[1], await conn.getName(owner[1] + '@s.whatsapp.net'), ' ', 'yanxiao021@gmail.com', true], // If you want to add it, just copy this 1 line and paste it below it, then edit it a bit!
        ]
		...
		// temporary message 
		global.ephemeral = '86400' // 86400 =24 hours, if you want to delete it, change '86400' to 'null' or ''
     		// externalAdReply or text with thumbnail.
		global.adReply = {
			contextInfo: {
				forwardingScore: 9999,
				//isForwarded: true, //this is so that the writing is continued many times, if you want to remove it, change true to false
				externalAdReply: { // This section is as creative as you like :'v
					...
					sourceUrl: "https://github.com/umar404",					
				}
			}
		}
		global.fpayment = {
...
global.fakefb = {
        ...
        global.fvn = {
            ...
            { remoteJid: "923165123719-1625305606@g.us" } : {}) 
                       },
            message: { 
               "audioMessage": {
            ...
            message: { "liveLocationMessage": { "caption":"by : Umar","h": `${wm}`, 'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')}}
           }
            ...
            participant: `0@s.whatsapp.net`, ...(m.chat ? 
            { remoteJid: "status@broadcast" } : {}) },
            message: { "liveLocationMessage": { "title": "Umar","h": wm, 'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')}}
           }
       ...
       key: {
           ...
           "message": {
               "groupInviteMessage": {
                   "groupJid": "923165123719-1625305606@g.us",
                   "inviteCode": "null",
                   "groupName": "Umar Devil", 
                   "caption": wm, 
                   'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')
               }
           }
